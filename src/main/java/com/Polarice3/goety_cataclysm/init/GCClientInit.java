...
public class GCClientInit {
    ...
    public static void onRegisterRenders(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(GCEntityType.DIMENSIONAL_RIFT.get(), DimensionalRiftRenderer::new);
        ...
        event.registerEntityRenderer(GCEntityType.LEVIATHAN_TONGUE.get(), RendererNull::new);
        ...
        event.registerEntityRenderer(GCEntityType.ABYSS_BLAST.get(), AbyssBlastRenderer::new);
