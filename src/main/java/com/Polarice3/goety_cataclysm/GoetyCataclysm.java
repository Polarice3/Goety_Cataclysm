...
import com.Polarice3.goety_cataclysm.common.world.GCMobSpawnBiomeModifier;
...
public class GoetyCataclysm {
    ...
    public GoetyCataclysm() {
        ...
        final DeferredRegister<Codec<? extends BiomeModifier>> biomeModifiers = DeferredRegister.create(ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, GoetyCataclysm.MOD_ID);
        biomeModifiers.register(modEventBus);
        biomeModifiers.register("mob_spawns", GCMobSpawnBiomeModifier::makeCodec);
    ...
    private void setupEntityAttributeCreation(final EntityAttributeCreationEvent event) {
        ...
        event.put(GCEntityType.LEVIATHAN.get(), LeviathanServant.setCustomAttributes().build());
        ...
        event.put(GCEntityType.ZOMBIE_AMETHYST_CRAB.get(), ZombieAmethystCrab.setCustomAttributes().build());
        ...
        event.put(GCEntityType.DRAUGR_NECROMANCER_SERVANT.get(), DraugrNecromancerServant.setCustomAttributes().build());
        event.put(GCEntityType.APTRGANGR.get(), AptrgangrServant.setCustomAttributes().build());
        event.put(GCEntityType.DRAUGR_NECROMANCER.get(), DraugrNecromancer.setCustomAttributes().build());
