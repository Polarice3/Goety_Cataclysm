...
public class GCEntityTypeTagsProvider extends IntrinsicHolderTagsProvider<EntityType<?>> {
    ...
    protected void addTags(HolderLookup.Provider p_255894_) {
        this.tag(EntityTypeTags.FALL_DAMAGE_IMMUNE)
                ...
                .add(GCEntityType.LEVIATHAN.get())
                ...
                .add(GCEntityType.ZOMBIE_AMETHYST_CRAB.get())
                .add(GCEntityType.APTRGANGR.get())
                .add(GCEntityType.CLAWDIAN.get())
                .add(GCEntityType.CINDARIA_SERVANT.get())
                .add(GCEntityType.URCHINKIN_SERVANT.get())
                .add(GCEntityType.HIPPOCAMTUS.get());
        this.tag(EntityTypeTags.FREEZE_IMMUNE_ENTITY_TYPES)
                ...
                .add(GCEntityType.DRAUGR_NECROMANCER_SERVANT.get())
                .add(GCEntityType.APTRGANGR.get())
