...
public class LeviathanServant extends LLibraryBossSummon implements ISemiAquatic, IAutoRideable {
    ...
    public final LeviathanServantPart headPart;
    public final LeviathanServantPart tailPart1;
    public final LeviathanServantPart tailPart2;

    public final LeviathanServantPart[] leviathanParts;
    ...
    public AbyssPortal portalTarget = null;
    ...
    private static final EntityDataAccessor<Integer> BLAST_CHANCE = SynchedEntityData.defineId(LeviathanServant.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> MODE_CHANCE = SynchedEntityData.defineId(LeviathanServant.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> MELT_DOWN = SynchedEntityData.defineId(LeviathanServant.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Optional<UUID>> TONGUE_UUID = SynchedEntityData.defineId(LeviathanServant.class, EntityDataSerializers.OPTIONAL_UUID);
    private static final EntityDataAccessor<Integer> TONGUE_ID = SynchedEntityData.defineId(LeviathanServant.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> AUTO_MODE = SynchedEntityData.defineId(LeviathanServant.class, EntityDataSerializers.BOOLEAN);

    public LeviathanServant(EntityType<? extends LeviathanServant> type, Level worldIn) {
        super(type, worldIn);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.setPathfindingMalus(BlockPathTypes.WATER_BORDER, 0.0F);
        if (worldIn.isClientSide)
            this.socketPosArray = new Vec3[]{
                    new Vec3(0, 0, 0)
        };
        this.headPart = new LeviathanServantPart(this, 2.8F, 2.8F);
        this.tailPart1 = new LeviathanServantPart(this, 1.5F, 2.4F);
        this.tailPart2 = new LeviathanServantPart(this, 1.3F, 2.4F);
        this.leviathanParts = new LeviathanServantPart[]{this.headPart,this.tailPart1,this.tailPart2};
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new Water3DWanderGoal<>(this, 1F, 3, 15));
        ...
        this.targetSelector.addGoal(3, new EntityAINearestTarget3D<>(this, LivingEntity.class, 160, false, true, ModEntities.buildPredicateFromTag(ModTag.LEVIATHAN_TARGET)){
            ...
            public boolean canUse() {
                return super.canUse() && LeviathanServant.this.isNatural();
            }
        });
    }
    ...
    public void followGoal() {
        this.goalSelector.addGoal(1, new FollowOwnerWaterGoal(this, 1.0, 10.0F, 2.0F));
    }
    ...
    public Predicate<Entity> summonPredicate() {
        return entity -> entity instanceof LeviathanServant;
    }
    ...
    public boolean attackEntityFromPart(LeviathanServantPart leviathan_part, DamageSource source, float amount) {
    ...
    public void aiStep() {
        ...
        if(this.getAnimation() == LEVIATHAN_ABYSS_BLAST_FIRE){
            ...
            if (this.getAnimationTick() == 84 || this.getAnimationTick() == 129 || this.getAnimationTick() == 174) {
                this.level().playSound((Player) null, this, CataclysmSounds.ABYSS_BLAST_ONLY_SHOOT.get(), this.getSoundSource(), 4.0f, 1.0f);
            }
        ...
        if(this.getAnimation() == LEVIATHAN_RUSH){
            if (this.getAnimationTick() == 54) {
                this.level().playSound((Player) null, this, CataclysmSounds.LEVIATHAN_ROAR.get(), this.getSoundSource(), 4.0f, 1.0f);
        ...
        if(this.getAnimation() == LEVIATHAN_STUN){
            if (this.getAnimationTick() == 52) {
                this.level().playSound((Player) null, this, CataclysmSounds.LEVIATHAN_STUN_ROAR.get(), this.getSoundSource(), 4.0f, 0.8f);
        ...
        if(this.getAnimation() == LEVIATHAN_BREAK_DIMENSION) {
            if (this.getAnimationTick() == 24) {
                this.level().playSound((Player) null, this, SoundEvents.WITHER_BREAK_BLOCK, this.getSoundSource(), 1.0f, 1.0f);
        ...
        if(this.getAnimation() == LEVIATHAN_BITE){
            if (this.getAnimationTick() == 11) {
                // charge();
                this.level().playSound((Player) null, this, CataclysmSounds.LEVIATHAN_BITE.get(), this.getSoundSource(), 1.0f, 1.0f);
            }
        ...
        if(this.getAnimation() == LEVIATHAN_PHASE2){
            if (this.getAnimationTick() == 90) {
                ...
                this.level().playSound((Player) null, this, CataclysmSounds.LEVIATHAN_STUN_ROAR.get(), this.getSoundSource(), 3.0f, 0.8f);
                ScreenShake_Entity.ScreenShake(this.level(), this.position(), 30, 0.1f, 40, 10);
                RoarParticle(this.getX() +fx * -4F, this.getY() -pitch * 3F, this.getZ() -fz * -4F,60, 102, 26, 204, 0.9f,1,1.2F,13);
    ...
    private void roarDarkness(double x, double y,double z, double radius,int time) {
        ...
        if (!this.level().isClientSide) {
            for (LivingEntity inRange : entities) {
                if (inRange instanceof Player && ((Player) inRange).getAbilities().invulnerable) {
                    continue;
                }
                if (MobUtil.areAllies(this, inRange)) {
                    continue;
                }
    ...
    private void TailWhips() {
        if (!this.level().isClientSide) {
            for (LivingEntity entity : this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(7.0D, 7.0D, 7.0D))) {
                if (!MobUtil.areAllies(this, entity) && !(entity instanceof LeviathanServant)) {
    ...
    public void shootAbyssOrb(double xMotion, double yMotion, double zMotion) {
        if(getTarget() != null) {
            AbyssOrb fireball = new AbyssOrb(this, xMotion, yMotion, zMotion, this.level(), (float) CMCommonConfig.Leviathan.AbyssOrbdamage,this.getTarget());
            ...
            AbyssOrb fireball = new AbyssOrb(this, xMotion, yMotion, zMotion, this.level(), (float) CMCommonConfig.Leviathan.AbyssOrbdamage,null);
            fireball.setPos(fireball.getX(), this.getEyeY(), fireball.getZ());
            fireball.setUp(40);
            if (!this.level().isClientSide) {
                this.level().addFreshEntity(fireball);
    ...
    private void chargeDamage(){
        if (this.tickCount % 4 == 0) {
            for (LivingEntity Lentity : this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(3D))) {
                if (!MobUtil.areAllies(this, Lentity) && !(Lentity instanceof LeviathanServant)) {
                    DamageSource damagesource = this.damageSources().mobAttack(this);
                    boolean flag = Lentity.hurt(damagesource,  (float) ((float) this.getAttributeValue(Attributes.ATTACK_DAMAGE) + Math.min(this.getAttributeValue(Attributes.ATTACK_DAMAGE), Lentity.getMaxHealth() * CMCommonConfig.Leviathan.RushHpDamage)));
    ...
    private void biteattack(float radius , double inflateX, double inflateY, double inflateZ,int stuntick) {
        ...
        if (!level().isClientSide) {
            ...
            for (LivingEntity target : hit) {
                if (!MobUtil.areAllies(this, target) && !(target instanceof LeviathanServant)) {
                    DamageSource damagesource = this.getServantAttack();
                    boolean flag = target.hurt(damagesource, (float) ((float) this.getAttributeValue(Attributes.ATTACK_DAMAGE) * 1.5 + Math.min(this.getAttributeValue(Attributes.ATTACK_DAMAGE) * 1.5, target.getMaxHealth() * CMCommonConfig.Leviathan.TentacleHpDamage)));
    ...
    private void Tentacleattack(int anime, float radius, double inflateX, double inflateY, double inflateZ) {
        ...
        if(this.getAnimationTick() == anime){
            this.playSound(CataclysmSounds.LEVIATHAN_TENTACLE_STRIKE.get(), 1.0F, 1.0F);
            ...
            if (!this.level().isClientSide) {
                ...
                for (LivingEntity target : hit) {
                    if (!MobUtil.areAllies(this, target) && !(target instanceof LeviathanServant)) {
                        DamageSource damagesource = this.getServantAttack();
                        boolean flag = target.hurt(damagesource, (float) ((float) this.getAttributeValue(Attributes.ATTACK_DAMAGE) + Math.min(this.getAttributeValue(Attributes.ATTACK_DAMAGE), target.getMaxHealth() * CMCommonConfig.Leviathan.TentacleHpDamage)));
                        if (target instanceof Player player && target.isDamageSourceBlocked(damagesource)) {
    ...
    public void positionRider(Entity passenger, Entity.MoveFunction moveFunc) {
        if (this.getFirstPassenger() == passenger && passenger != this.getTrueOwner()) {
            if (this.getAnimation() == LEVIATHAN_TENTACLE_HOLD_BLAST) {
    ...
    public boolean shouldRiderSit() {
        return this.getControllingPassenger() != null
                && this.getFirstPassenger() == this.getTrueOwner();
    }
    ...
    public void die(DamageSource cause) {
        if (this.getTrueOwner() != null) {
            ItemStack itemStack = new ItemStack(CataclysmBlocks.ABYSSAL_EGG.get());
            ...
            flyingItem.setParticle(ParticleTypes.PORTAL);
    ...
    public void createPortal2(double x, double y, double z, Vec3 to) {
        if (!level().isClientSide && portalTarget == null) {
            AbyssPortal portal = GCEntityType.ABYSS_PORTAL.get().create(level());
            if (portal != null) {
                portal.setPos(x, y, z);
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return CataclysmSounds.LEVIATHAN_HURT.get();
    }

    protected SoundEvent getDeathSound() {
        return CataclysmSounds.LEVIATHAN_DEFEAT.get();
    }
    ...
    private void setPartPosition(LeviathanServantPart part, double offsetX, double offsetY, double offsetZ) {
    ...
    static class LeviathanGrabAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanGrabAttackGoal(LeviathanServant entity, Animation animation) {
    ...
    static class LeviathanGrabBiteAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanGrabBiteAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
        ...
        public void start() {
            ...
            entity.level().playSound((Player) null, entity, CataclysmSounds.LEVIATHAN_BITE.get(), entity.getSoundSource(), 1.0f, 1.0f);
            super.start();
        }
    ...
    static class LeviathanBiteAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanBiteAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    static class LeviathanPhase2Goal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanPhase2Goal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    static class LeviathanBlastAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanBlastAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
        ...
        public void start() {
            entity.getNavigation().stop();
            entity.level().playSound((Player) null, entity, CataclysmSounds.ABYSS_BLAST.get(), entity.getSoundSource(), 4.0f, 1.0f);
            entity.CanAbyss_Blast_Portal = true;
            entity.CanGrab = true;
            entity.CanRush = true;
            entity.CanBite = true;
    ...
    static class LeviathanBlastFireAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanBlastFireAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
        ...
        public void start() {
            entity.getNavigation().stop();
            entity.level().playSound((Player) null, entity, CataclysmSounds.ABYSS_BLAST_ONLY_CHARGE.get(), entity.getSoundSource(), 4.0f, 1.0f);
            entity.CanAbyss_Blast_Portal = true;
            entity.CanGrab = true;
            entity.CanRush = true;
            entity.CanBite = true;
    ...
    static class LeviathanTailWhipsAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanTailWhipsAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    static class LeviathanRushAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanRushAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    static class LeviathanTentacleAttackGoal extends SummonAnimationGoal<LeviathanServant> {

        public LeviathanTentacleAttackGoal(LeviathanServant entity) {
            super(entity);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    static class LeviathanAbyssBlastPortalAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanAbyssBlastPortalAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
        ...
        private void spawnUnderPortal(double x, double z, double minY, double maxY, float rotation, int delay) {
            ...
            if (flag) {
                entity.level().addFreshEntity(new AbyssBlastPortal(entity.level(), x, (double) blockpos.getY() + d0, z, rotation, delay, (float)CMCommonConfig.Leviathan.AbyssBlastDamage,(float)CMCommonConfig.Leviathan.AbyssBlastHpDamage,entity));
            }
        }
        ...
        private void spawnUpperPortal(double x, double z, double maxY, float rotation, int delay) {
            ...
            if (flag) {
                entity.level().addFreshEntity(new AbyssBlastPortal(entity.level(), x, (double) blockpos.getY() + d0 + 0.5F, z, rotation, delay,(float)CMCommonConfig.Leviathan.AbyssBlastDamage,(float)CMCommonConfig.Leviathan.AbyssBlastHpDamage, entity));
            }
        }
    }
    ...
    static class LeviathanAbyssDimensionAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanAbyssDimensionAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    static class LeviathanTentacleHoldAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanTentacleHoldAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    static class LeviathanTentacleHoldBlastAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanTentacleHoldBlastAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    static class LeviathanMineAttackGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanMineAttackGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
        ...
        private void spawnMines(double x, double y, double z, float rotation, int delay) {
            AbyssMine mine = new AbyssMine(entity.level(), x, y, z, rotation, delay, entity);
    ...
    static class LeviathanStunGoal extends SimpleSummonAnimationGoal<LeviathanServant> {

        public LeviathanStunGoal(LeviathanServant entity, Animation animation) {
            super(entity, animation);
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    class LeviathanAttackGoal extends Goal {
        private final LeviathanServant mob;
        ...
        public LeviathanAttackGoal(LeviathanServant mob) {
            this.mob = mob;
    ...
    static class LeviathanMoveController extends MoveControl {
        private final LeviathanServant entity;
        private final float speedMulti;
        private final float ySpeedMod;
        private final float yawLimit;
        private  int stillTicks = 0;
        public LeviathanMoveController(LeviathanServant entity, float speedMulti, float ySpeedMod, float yawLimit) {
            super(entity);
            this.entity = entity;
