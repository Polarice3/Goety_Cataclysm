...
public class KoboletonSpell extends SummonSpell {

    public int defaultSoulCost() {
        return GCSpellConfig.KoboletonCost.get();
    }

    public int defaultCastDuration() {
        return GCSpellConfig.KoboletonDuration.get();
    }

    public int SummonDownDuration() {
        return GCSpellConfig.KoboletonSummonDown.get();
    }
    ...
    public int defaultSpellCooldown() {
        return GCSpellConfig.KoboletonCoolDown.get();
    }
    ...
    public Predicate<LivingEntity> summonPredicate() {
        return livingEntity -> livingEntity instanceof KoboletonServant;
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (!isShifting(caster)) {
            ...
            for (int i1 = 0; i1 < i; ++i1) {
                KoboletonServant summonedentity = new KoboletonServant(GCEntityType.KOBOLETON_SERVANT.get(), worldIn);
