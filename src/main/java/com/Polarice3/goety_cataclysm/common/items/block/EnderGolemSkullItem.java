package com.Polarice3.goety_cataclysm.common.items.block;
...
public class EnderGolemSkullItem extends StandingAndWallBlockItem {

    public EnderGolemSkullItem(Properties p_43250_) {
        super(GCBlocks.ENDER_GOLEM_SKULL_BLOCK.get(), GCBlocks.WALL_ENDER_GOLEM_SKULL_BLOCK.get(), p_43250_, Direction.DOWN);
    }
