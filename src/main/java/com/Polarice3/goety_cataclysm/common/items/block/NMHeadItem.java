...
public class NMHeadItem extends StandingAndWallBlockItem {

    public NMHeadItem(Properties p_43250_) {
        super(GCBlocks.NETHERITE_MONSTROSITY_HEAD_BLOCK.get(), GCBlocks.WALL_NETHERITE_MONSTROSITY_HEAD_BLOCK.get(), p_43250_, Direction.DOWN);
    }
