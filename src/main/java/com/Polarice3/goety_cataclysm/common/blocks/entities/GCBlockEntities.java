...
public class GCBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<NMHeadBlockEntity>> NETHERITE_MONSTROSITY_HEAD = BLOCK_ENTITY.register("netherite_monstrosity_head",
            () -> BlockEntityType.Builder.of(NMHeadBlockEntity::new, GCBlocks.NETHERITE_MONSTROSITY_HEAD_BLOCK.get(), GCBlocks.WALL_NETHERITE_MONSTROSITY_HEAD_BLOCK.get()).build(null));
