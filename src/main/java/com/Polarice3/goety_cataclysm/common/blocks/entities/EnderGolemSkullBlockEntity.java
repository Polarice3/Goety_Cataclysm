...
public class EnderGolemSkullBlockEntity extends SkullBlockEntity {
    private UUID ownerUUID;
    private String customName;

    public EnderGolemSkullBlockEntity(BlockPos p_155731_, BlockState p_155732_) {
        super(p_155731_, p_155732_);
    }

    @Override
    public BlockEntityType<?> getType() {
        return GCBlockEntities.ENDER_GOLEM_SKULL.get();
    }
    ...
    public ResourceLocation getNoteBlockSound() {
        return GoetySounds.REDSTONE_GOLEM_AMBIENT.get().getLocation();
    }
