...
public class NMHeadBlockEntity extends SkullBlockEntity {
    private UUID ownerUUID;
    private String customName;

    public NMHeadBlockEntity(BlockPos p_155731_, BlockState p_155732_) {
        super(p_155731_, p_155732_);
    }

    @Override
    public BlockEntityType<?> getType() {
        return GCBlockEntities.NETHERITE_MONSTROSITY_HEAD.get();
    }
