...
public class DimensionalRiftRenderer extends EntityRenderer<DimensionalRift> {
    ...
    public DimensionalRiftRenderer(EntityRendererProvider.Context mgr) {
        super(mgr);
    }

    public void render(DimensionalRift entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    @Override
    public ResourceLocation getTextureLocation(DimensionalRift entity) {
