...
public class DeeplingBruteServantModel extends AdvancedEntityModel<DeeplingBruteServant> {
    ...
    public DeeplingBruteServantModel() {
        texWidth = 128;
        texHeight = 128;
    ...
    public void animate(DeeplingBruteServant entity, float f, float f1, float f2, float f3, float f4) {
        this.resetToDefaultPose();
        animator.update(entity);
        animator.setAnimation(DeeplingBruteServant.DEEPLING_BRUTE_TRIDENT_THROW);
        ...
        animator.setAnimation(DeeplingBruteServant.DEEPLING_BRUTE_MELEE);
    ...
    @Override
    public void setupAnim(DeeplingBruteServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
