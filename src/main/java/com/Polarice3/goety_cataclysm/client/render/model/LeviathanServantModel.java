...
public class LeviathanServantModel extends AdvancedEntityModel<LeviathanServant> {
	...
	public void animate(LeviathanServant entity, float f, float f1, float f2, float f3, float f4) {
		this.resetToDefaultPose();
		animator.update(entity);
		animator.setAnimation(LeviathanServant.LEVIATHAN_GRAB);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_GRAB_BITE);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_ABYSS_BLAST);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_RUSH);
		animator.startKeyframe(25);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_ABYSS_BLAST_PORTAL);
		animator.startKeyframe(25);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_TENTACLE_STRIKE_UPPER_R);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_TENTACLE_STRIKE_LOWER_R);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_TENTACLE_STRIKE_UPPER_L);
		animator.startKeyframe(25);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_TENTACLE_STRIKE_LOWER_L);
		animator.startKeyframe(20);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_STUN);
		animator.startKeyframe(0);
		animator.rotate(UpperR_Tentacle,0,(float)Math.toRadians(37.5F), 0);
		animator.rotate(UpperR_Tentacle2,0,(float)Math.toRadians(45F), 0);
		animator.rotate(UpperR_Tentacle3,0,(float)Math.toRadians(50F), 0);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_TAIL_WHIPS);
		animator.startKeyframe(12);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_BREAK_DIMENSION);
		animator.startKeyframe(10);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_BITE);
		animator.startKeyframe(8);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_PHASE2);
		animator.startKeyframe(10);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_DEATH);
		animator.startKeyframe(15);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_TENTACLE_HOLD);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_TENTACLE_HOLD_BLAST);
		animator.startKeyframe(0);
		animator.move(root,0,0,-3);
		animator.rotate(Belly,(float)Math.toRadians(5f),0,0);
		animator.rotate(Tail,(float)Math.toRadians(-7.5f),0,0);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_ABYSS_BLAST_FIRE);
		animator.startKeyframe(20);
		animator.rotate(Maw, (float) Math.toRadians(20F), 0, 0);
		animator.rotate(Skul, (float) Math.toRadians(-20F), 0, 0);
		animator.rotate(Mouth, (float) Math.toRadians(-15F), (float) Math.toRadians(7.5F), 0);
		...
		animator.setAnimation(LeviathanServant.LEVIATHAN_MINE);
		animator.startKeyframe(15);
		animator.rotate(root, (float) Math.toRadians(5F), 0, 0);
		animator.rotate(Belly, (float) Math.toRadians(-2.5F), 0, 0);
	...
	@Override
	public void setupAnim(LeviathanServant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
