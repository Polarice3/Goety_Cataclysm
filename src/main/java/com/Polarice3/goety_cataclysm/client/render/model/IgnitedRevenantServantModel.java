...
public class IgnitedRevenantServantModel extends AdvancedEntityModel<IgnitedRevenantServant> {
    ...
    public IgnitedRevenantServantModel() {
        texWidth = 128;
        texHeight = 128;
    ...
    public void animate(IgnitedRevenantServant entity, float f, float f1, float f2, float f3, float f4) {
        this.resetToDefaultPose();
        animator.update(entity);
        animator.setAnimation(IgnitedRevenantServant.ASH_BREATH_ATTACK);
        ...
        animator.setAnimation(IgnitedRevenantServant.BONE_STORM_ATTACK);
        if(!entity.getIsAnger()) {
    ...
    @Override
    public void setupAnim(IgnitedRevenantServant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
