...
public class DeeplingAnglerServantModel extends AdvancedEntityModel<DeeplingAnglerServant> {
    ...
    public DeeplingAnglerServantModel() {
        texWidth = 128;
        texHeight = 128;
    ...
    public void animate(DeeplingAnglerServant entity, float f, float f1, float f2, float f3, float f4) {
        this.resetToDefaultPose();
        animator.update(entity);
        animator.setAnimation(DeeplingAnglerServant.DEEPLING_MELEE);
        ...
        animator.setAnimation(DeeplingAnglerServant.DEEPLING_HUG);
    ...
    @Override
    public void setupAnim(DeeplingAnglerServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
