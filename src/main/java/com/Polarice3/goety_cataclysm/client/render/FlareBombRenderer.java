...
public class FlareBombRenderer extends EntityRenderer<FlareBomb> {
    ...
    public FlareBombRenderer(EntityRendererProvider.Context renderManagerIn) {
        ...
        model = new FlareBombModel(renderManagerIn.bakeLayer(CMModelLayers.FLARE_BOMB_MODEL));
    }
    ...
    private void renderTrail(FlareBomb entityIn, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, float trailR, float trailG, float trailB, float trailA, int packedLightIn) {
        int sampleSize = 10;
