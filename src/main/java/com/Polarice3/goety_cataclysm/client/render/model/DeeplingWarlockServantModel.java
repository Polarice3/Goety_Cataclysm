...
public class DeeplingWarlockServantModel extends AdvancedEntityModel<DeeplingWarlockServant> {
    ...
    public DeeplingWarlockServantModel() {
        texWidth = 128;
        texHeight = 128;
    ...
    public void animate(DeeplingWarlockServant entity, float f, float f1, float f2, float f3, float f4) {
        this.resetToDefaultPose();
        animator.update(entity);
        animator.setAnimation(DeeplingWarlockServant.DEEPLING_MAGIC);
        ...
        animator.setAnimation(DeeplingWarlockServant.DEEPLING_MELEE);
    ...
    @Override
    public void setupAnim(DeeplingWarlockServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
