...
public class DeeplingServantModel extends AdvancedEntityModel<DeeplingServant> {
    ...
    public void animate(DeeplingServant entity, float f, float f1, float f2, float f3, float f4) {
        this.resetToDefaultPose();
        animator.update(entity);
        animator.setAnimation(DeeplingServant.DEEPLING_TRIDENT_THROW);
        ...
        animator.setAnimation(DeeplingServant.DEEPLING_MELEE);
        if(entity.isLeftHanded()){
    ...
    @Override
    public void setupAnim(DeeplingServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
