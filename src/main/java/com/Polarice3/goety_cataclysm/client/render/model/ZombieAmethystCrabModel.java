...
public class ZombieAmethystCrabModel extends AdvancedEntityModel<ZombieAmethystCrab> {
	...
	public ZombieAmethystCrabModel() {
		texWidth = 256;
		texHeight = 256;
	...
	public void animate(ZombieAmethystCrab entity, float f, float f1, float f2, float f3, float f4) {
		...
		animator.setAnimation(ZombieAmethystCrab.CRAB_SMASH);
		...
		animator.setAnimation(ZombieAmethystCrab.CRAB_SMASH_THREE);
		...
		animator.setAnimation(ZombieAmethystCrab.CRAB_DEATH);
		...
		animator.setAnimation(ZombieAmethystCrab.CRAB_BURROW);
		...
		animator.setAnimation(ZombieAmethystCrab.CRAB_BITE);
		animator.startKeyframe(12);
	...
	@Override
	public void setupAnim(ZombieAmethystCrab entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
