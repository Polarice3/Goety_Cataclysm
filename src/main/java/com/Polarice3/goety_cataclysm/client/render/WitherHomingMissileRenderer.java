...
public class WitherHomingMissileRenderer extends EntityRenderer<WitherHomingMissile> {
    ...
    private void renderTrail(WitherHomingMissile entityIn, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, float trailR, float trailG, float trailB, float trailA, int packedLightIn) {
