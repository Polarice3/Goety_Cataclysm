...
public class DeathLaserBeamRenderer extends EntityRenderer<DeathLaserBeam> {
    ...
    public DeathLaserBeamRenderer(EntityRendererProvider.Context mgr) {
        super(mgr);
    }

    @Override
    public ResourceLocation getTextureLocation(DeathLaserBeam entity) {
        return TEXTURE;
    }

    @Override
    public void render(DeathLaserBeam solarBeam, float entityYaw, float delta, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    private void renderLighting(float frame, PoseStack poseStack,DeathLaserBeam entity, MultiBufferSource buffer) {
