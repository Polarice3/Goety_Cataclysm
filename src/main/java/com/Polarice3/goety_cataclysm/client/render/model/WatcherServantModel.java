...
public class WatcherServantModel extends AdvancedEntityModel<WatcherServant> {
    ...
    public void animate(WatcherServant entity, float f, float f1, float f2, float f3, float f4) {
        this.resetToDefaultPose();
        animator.update(entity);
        animator.setAnimation(WatcherServant.WATCHER_BITE);
        ...
        animator.setAnimation(WatcherServant.WATCHER_EXTRA_SHOT);
        ...
        animator.setAnimation(WatcherServant.WATCHER_SHOT);
    ...
    @Override
    public void setupAnim(WatcherServant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
