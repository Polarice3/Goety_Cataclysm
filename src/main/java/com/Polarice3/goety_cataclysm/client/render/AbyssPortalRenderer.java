...
public class AbyssPortalRenderer extends EntityRenderer<AbyssPortal> {
    ...
    public AbyssPortalRenderer(EntityRendererProvider.Context renderManagerIn) {
    ...
    public void render(AbyssPortal entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    private void renderPortal(AbyssPortal entityIn, PoseStack matrixStackIn, MultiBufferSource bufferIn, boolean shattered){
    ...
    @Override
    public ResourceLocation getTextureLocation(AbyssPortal entity) {
        return TEXTURE_0;
    }
