...
public class KoboletonServantModel extends AdvancedEntityModel<KoboletonServant> {
	...
	public void animate(KoboletonServant entity, float f, float f1, float f2, float f3, float f4) {
		this.resetToDefaultPose();
		animator.update(entity);
		animator.setAnimation(KoboletonServant.COBOLETON_ATTACK);
	...
	@Override
	public void setupAnim(KoboletonServant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
