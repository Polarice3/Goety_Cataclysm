...
public class SandstormModel extends AdvancedEntityModel<Sandstorm> {
    ...
    @Override
    public void setupAnim(Sandstorm entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
